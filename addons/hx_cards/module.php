...
class Hx_cardsModule extends WeModule {
	...
	public function fieldsFormDisplay($rid = 0) {
		...
		if($rid==0){
			$reply = array(
				'title'=> '刮刮乐活动开始了!',
				'description' => '刮刮乐活动开始啦！',
				'tips'	=>	'每次刮奖需要花费50积分，一等奖为39元的现金抵扣券，二等奖为100积分，三等奖为50积分，四等奖为30积分。每人每天限抽2次。',
				'remark'	=>	'中奖积分请到会员主页查看',
				'starttime' => time(),
				...
				'onlynone' => '1',
				'noprize' => '哎呀，肯定姿势不对',
				'share_title'=> '欢迎参加刮刮乐抽奖活动',
				'share_content'=> '亲，欢迎参加刮刮乐抽奖活动，祝您好运哦！！ 亲，需要绑定账号才可以参加哦',
			);
			$prizes = array(
				'p1_type' => 'credit1',
				);
